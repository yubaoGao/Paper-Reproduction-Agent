# Borrowed from /home/ubuntu/miniconda3/envs/langgraph/lib/python3.11/site-packages/langchain_experimental/llm_bash/bash.py
...
class BashProcess:
    ...
    def run(self, commands: Union[str, List[str]], timeout: int) -> str:
        """
