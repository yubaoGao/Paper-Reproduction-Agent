...
from backend.app.domain import EvidenceReference,RepositoryAnalysisCatalog,RepositoryAnalysisTrace,RepositoryComponentRecord,RepositoryConflict,RepositoryExperimentImplementation,RepositoryFact
...
class RepositoryStageExtraction(BaseModel):
    components:tuple[RepositoryComponentRecord,...]=(); implementations:tuple[RepositoryExperimentImplementation,...]=(); conflicts:tuple[RepositoryConflict,...]=(); facts:tuple[RepositoryFact,...]=(); evidence:tuple[EvidenceReference,...]=(); missing_components:tuple[str,...]=(); warnings:tuple[str,...]=()
