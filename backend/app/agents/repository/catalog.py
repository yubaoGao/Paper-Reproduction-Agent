...
class RepositoryCatalogMerger:
    def merge(self,snapshot,static,stages,missing=(),warnings=()):
        ...
        evidence=[]
        groups=(static.documentation,static.environment_definitions,static.dependencies,static.entrypoints,static.configurations,static.datasets,static.models,static.ablations,static.metrics,static.checkpoints,static.artifacts,static.commands,implementations)
        for group in groups:
...
class RepositoryCatalogValidator:
    ...
    def validate(self,catalog,snapshot,static):
        ...
        for group in (catalog.documentation,catalog.environment_definitions,catalog.dependencies,catalog.entrypoints,catalog.configurations,catalog.datasets,catalog.models,catalog.experiment_implementations,catalog.ablation_mechanisms,catalog.metrics,catalog.checkpoints,catalog.artifact_paths,catalog.commands):
            for record in group:all_evidence.extend(record.evidence)
